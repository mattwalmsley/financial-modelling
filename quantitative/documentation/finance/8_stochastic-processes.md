...
- As $x \rightarrow \pm \infty$, the normal density (and the probability) will decay exponentially.
...
- A more subtle problem is that the unit-size of the move up/down is the same regardless of the price level - this is due to the next move being independent of all previous moves.
  - In practice, this is not the case as a 1 USD move up/down on a stock is far more likely when it is valued at 100 USD($\pm 1\%$) than when it is valued at 2 USD($\pm 50\%$).
